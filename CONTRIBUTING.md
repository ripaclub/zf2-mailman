...
Contributions to MailMan ZF2 module are always welcomed and encouraged.
...
If you have questions about how to use MailMan ZF2 module please write at <ripaclub@gmail.com>.

Other communication channels will be activated soon. In the mean time you can also contact us writing a [new issue](https://github.com/ripaclub/zf2-mailman/issues/new).
...
Bug triaging is managed via github [issues](https://github.com/ripaclub/zf2-mailman/issues).

You can help report bugs by filing them [here](https://github.com/ripaclub/zf2-mailman/issues).
...
1. **Fork** the sphinxsearch [repository](https://github.com/ripaclub/zf2-mailman/fork)
